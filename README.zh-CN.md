...
1. **合约部署**（管理员 cl6 操作）
   ...
   ```bash
   aptos move publish --named-addresses tradingflow_vault=<cl6的地址> --profile cl6
   ```
...
```bash
aptos move test --named-addresses tradingflow_vault=<cl6的地址>
```
